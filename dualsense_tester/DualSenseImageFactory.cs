...
public class DrawingImageCreator
{
    public DrawingImage CreateDualSenseDrawingImage()
    {
        ...
        // Controller Bottom
        // 
        GeometryDrawing controllerBottomGD1 = new GeometryDrawing
        {
            Pen = new Pen
            {
                Brush = Brushes.Black,
        ...
        GeometryDrawing controllerBottomGD2 = new GeometryDrawing
        {
            ...
            Geometry = Geometry.Parse("F0 M1117,892z M0,0z M1003.45,436.511C1017.29,438.306,1031.13,435.352,1044.97,430")
        };

        DrawingGroup controllerBottom = new DrawingGroup
        {
            Opacity = 1,
        ...
        controllerBottom.Children.Add(controllerBottomGD1);
        controllerBottom.Children.Add(controllerBottomGD2);

        //
        // Mic Button
        //
        GeometryDrawing micButtonGD = new GeometryDrawing
        {
            Pen = new Pen
            {
                Brush = Brushes.Black,
        ...
        micButton.Children.Add(micButtonGD);

        //
        // Top of Controller
        //
        GeometryDrawing controllerTopGD = new GeometryDrawing
        {
            Pen = new Pen
            {
                Brush = Brushes.Black,
        ...
        DrawingGroup controllerTop = new DrawingGroup
        {
            Opacity = 1,
            Transform = new MatrixTransform(new Matrix(
                                                        -1.04799,
        ...
        controllerTop.Children.Add(controllerTopGD);

        //
        // Right Side Handle 
        //
        GeometryDrawing unkwownGD = new GeometryDrawing
        {
            Pen = new Pen
            {
                Brush = Brushes.Black,
        ...
        unknown.Children.Add(unkwownGD);
        ...
        drawing_2.Children.Add(controllerTop);
